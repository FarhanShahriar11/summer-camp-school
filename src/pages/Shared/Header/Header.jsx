...
const Header = () => {
    ...
    <li><Link to='/instructor' id='items-2' className='text-[var(--text-primary-color)]'>Instructors</Link></li>
    ...
    <div className='bg-[var(--bg-color)] top-0 z-50 shadow-md'>
    <div className="navbar w-11/12 mx-auto">
        <div className="navbar-start">
            ...
            <Link><img src={logo} className='w-[100px]' alt="" /></Link>
        </div>
                ...
                !loading ? <>
                    {
                        user ? <div className='flex items-center gap-2'>
                            ...
                            <Link className='bg-[var(--common-secondary-color)] flex items-center justify-center ps-2 rounded-md py-[10px]' onClick={handleUserLogout}><BsBoxArrowRight className='text-black' size={22} /></Link>
                        </div>
                            : <Link to='/login' className='custom-btn text-black'>Login Here</Link>
                    }
                </> : <RotatingLines
                    strokeColor="#9833f9"
                    strokeWidth="5"
